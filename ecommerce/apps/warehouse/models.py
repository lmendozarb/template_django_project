...
class Product(models.Model):
    ...
    regular_price = models.DecimalField("Precio Regular", max_digits=10, decimal_places=2)
    sales_prices = models.DecimalField("Precio de Venta", max_digits=10, decimal_places=2)
